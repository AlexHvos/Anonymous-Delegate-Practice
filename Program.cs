...
int[] evenArray = GetFiltered(array, delegate (int number) {
    if (number % 2 == 0) {
           return true;
       }
       return false;
});
int[] notEvenArray = GetFiltered(array, delegate (int number) {
    if (number % 2 != 0) {
           return true;
       }
       return false;
...
int[] hasSameNumberArray = GetFiltered(array, delegate (int number){
